 ...
 */
class Troop380_Eagle_Scout_Post_Type {
    ...
    private function register_single_post_type( $fields ) {
        ...
        $labels = array(
            ...
            'add_new_item'          => sprintf( __( 'Add %s', 'plugin-name' ), $fields['singular'] ),
        ...
        $post_types_fields = array(
            ...
            array(
                ...
                'rewrite' => array(
                    ...
                    'slug'       => 'eaglescout', // string (defaults to the post type name)
    ...
    public function upgrade_to_v_1_1_0() {
		global $wpdb;
