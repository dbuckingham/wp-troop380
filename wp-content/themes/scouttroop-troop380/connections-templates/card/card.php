...
<div class="cn-entry" style="<?php _escape::css( $css, true ); ?>">
	...
	// If a merit badge counselor, list merit badges
	$merit_badges_group = $entry->getMeta(
		array(
			'key' => 'merit_badges', 	// This should match exactly the field id used when registering the custom field.
